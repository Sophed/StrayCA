...
public class ForceCASpeed implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        if (!(sender instanceof Player)) {
            ...
            if (targetPlayer != null) {
                ...
                targetPlayer.getServer().dispatchCommand(getServer().getConsoleSender(), "kit give Speed " + targetPlayer.getName());
